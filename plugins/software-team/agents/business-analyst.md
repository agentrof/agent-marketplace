...
description: Business analyst role. Runs the interactive analysis persona of software-team flows and grows the topic's analysis space; invoked with explicit inputs, never auto-triggered.
model: opus
---
