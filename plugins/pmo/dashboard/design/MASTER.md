# Agentrof PMO Dashboard - Design System Master
...
- Product: Agentrof PMO Dashboard, a read-only, localhost operations view over the multi-agent team's work orders, project board, quality ledger, and audit trail. No write actions live in this surface.
