...
VALID_VAULT_POLICY = {
    ...
    "decision_trees": {
        "notes": {"path": "notes/decisions", "id_prefix": "SD",
                  "id_min_width": 3, "code_in_filename": False,
                  "render_index": True},
    },
    "generated_views": ["backlog.md"],
...
# Dynamic home: extra maps and start-here only; a subtree's map line is
# added by the entry that births the tree.
...
def make_valid_root(root: Path) -> None:
    ...
    write(vault_tpl / "start-here.md",
          "# Start Here\n\nOpen the docs directory as the vault root.\n")
    write(vault_tpl / "maps" / "notes.md", "# Notes Map\n\nSubtree hub.\n")
    write(vault_tpl / "maps" / "delivery.md", "# Delivery Map\n\nDelivery views.\n")
...
def break_ba_schema_shape(root: Path) -> None:
    # Valid in every other respect; the single defect is a minted kind
    ...
    write(
        ...
        json.dumps({
            ...
            "challenge": {
                "round_file_format": "{slug}-round-{n}.md",
                "space_round_file_format": "{slug}-space-round-{n}.md",
            },
