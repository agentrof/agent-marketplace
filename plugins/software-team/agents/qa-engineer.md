---
name: software-team-qa-engineer
description: QA engineer role. Spawned by software-team flows after review to audit coverage, run the suite and verify the running application; never auto-triggered.
model: sonnet
---
