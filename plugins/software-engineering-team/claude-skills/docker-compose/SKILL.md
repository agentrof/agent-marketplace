...
Read `${CLAUDE_PLUGIN_ROOT}/skill-content/docker-compose/SKILL.md` completely, then follow it as the authoritative workflow. Resolve every relative resource from that canonical skill directory.
