...
Read `${CLAUDE_PLUGIN_ROOT}/skill-content/qa-verification/SKILL.md` completely, then follow it as the authoritative workflow. Resolve every relative resource from that canonical skill directory.
