# -*- coding: utf-8 -*-
"""BM25 search engine over the design intelligence CSV corpus.

Pure standard library. Data files resolve relative to this script so the
search works from any working directory.
"""
...
def detect_domain(query):
    ...
    domain_keywords = {
        ...
        "ux": ["ux", "usability", "accessibility", "wcag", "touch", "scroll", "animation", "keyboard", "navigation", "mobile", "aria", "focus", "outline", "form", "input type"],
        "typography": ["font pairing", "typography pairing", "heading font", "body font", "font", "typography", "serif", "sans"],
