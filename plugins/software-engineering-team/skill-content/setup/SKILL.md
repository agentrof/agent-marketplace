...
On Codex, first read `references/codex-setup.md` and apply its host
pre-flight, gate, materialization, and restart rules. In template paths,
`{{workspace}}` means the chosen workspace directory name.
