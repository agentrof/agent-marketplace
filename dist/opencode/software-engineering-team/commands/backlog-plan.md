...
Read `{{AGENT_MARKETPLACE_OPENCODE_PACKAGE_ROOT}}/skill-content/backlog-plan/SKILL.md` and follow it exactly. For a declared decision, ask in ordinary conversation text with clear numbered options. Do not mutate until the user answers. Agent Marketplace run mode: tui_only.
