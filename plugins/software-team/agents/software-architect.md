---
name: software-team-software-architect
description: Software architect role. Spawned by software-team flows to evolve the living architecture documents delta-first; never auto-triggered.
model: opus
---
