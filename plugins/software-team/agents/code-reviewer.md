---
name: software-team-code-reviewer
description: Code reviewer role. Spawned by software-team flows after implementation to audit the change and emit a verdict; never auto-triggered.
model: opus
---
