...
1. Resolve the CLI: prefer the synced launcher
   ...
   Claude records it in installed_plugins.json inside the user-level
   Claude plugins directory; Codex installs it below the Codex plugin
   cache and the SessionStart hook records it in
