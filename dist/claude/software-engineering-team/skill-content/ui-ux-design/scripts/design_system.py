...
def catalog_token_block(design_system: dict) -> list[str]:
    ...
    lines = [
        ...
        f"  --catalog-border: {color('border', colors, '#737373')};",
        ...
        f"  --catalog-border: {color('border', dark, '#a3a3a3')};",
...
def format_master_md(design_system: dict) -> str:
    ...
    # A direct, natural graph label. The fixed type/tag supplies the
    # classification independently from the user-facing title.
