...
Read `../../codex/host-contract.md` and `../../skill-content/organize-docs/SKILL.md` completely, resolving both paths relative to this file. Follow the canonical skill as the workflow and the Codex contract as the host adapter.
