...
Repository maintainers use the separate
[issue and release automation protocol](docs/maintainer-automation-protocol.md);
issue text never grants merge or release authority.
